...
namespace SchoolManagement.Web.Migrations
{
    ...
    [Migration("20250815222035_AddAlertsSystem")]
    partial class AddAlertsSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagement.Web.Data.Entities.SubjectEnrollmentRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SubjectEnrollmentRequests");
                });
            ...
            modelBuilder.Entity("SchoolManagement.Web.Data.Entities.Alert", b =>
                {
                    ...
                    b.HasOne("SchoolManagement.Web.Data.Entities.StudentGrade", "StudentGrade")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolManagement.Web.Data.Entities.SubjectEnrollmentRequest", b =>
                {
                    b.HasOne("SchoolManagement.Web.Data.Entities.ApplicationUser", "ProcessedBy")
                        .WithMany()
